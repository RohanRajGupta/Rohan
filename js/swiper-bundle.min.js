...
!function(e, t) {
    ...
    var I = {
        ...
        slideToLoop: function(e, t, s, a) {
            ...
            const i = this;
            let r = e;
            return i.params.loop && (i.virtual && i.params.virtual.enabled ? r += i.virtual.slidesBefore : r = b(i.slides.filter((e=>1 * e.getAttribute("data-swiper-slide-index") === r))[0])),
            i.slideTo(r, t, s, a)
        },
            ...
            s)
                if (g.length > 0 && E)
                    ...
                    if (void 0 === t) {
                        ...
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(w - S, 0, !1, !0),
                        i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
                    } else
    ...
    , function(e) {
            ...
            "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                r.length > 1)
                    i.forEach((e=>{
                        ...
                        s.dynamicBullets && (t >= o && t <= d && e.classList.add(`${s.bulletActiveClass}-main`),
                        t === o && c(e, "prev"),
                        t === d && c(e, "next"))
                    }
                    ));
                    ...
                    const e = i[a];
                    if (e && e.classList.add(s.bulletActiveClass),
                    s.dynamicBullets) {
                        const e = i[o]
                          , t = i[d];
                        for (let e = o; e <= d; e += 1)
        ...
        function m() {
            ...
            a.forEach((s=>{
                ...
                "bullets" === e.type && (t.pagination.bullets = [...s.querySelectorAll(ee(e.bulletClass))])
            }
            )),
